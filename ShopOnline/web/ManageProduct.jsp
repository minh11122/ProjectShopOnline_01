        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Danh sách Product</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            ...
                            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>  <c:forEach items = "${listP}" var = "o" >

                                        <tr>

                                            <td> ${o.getIdP()}</td>
                                            <td>${o.getNameProduct()}</td>  
                                            <td>  <img class="img-card-person" src="${o.getImgProduct()}" alt=""></td>
                                            <td>${o.getPriceProduct()}</td>
                                            <td>${o.getTiltleProduct()} </td>
                                            <td>${o.getDescriptionProduct()}</td>     
                                            <td class="table-td-center">

                                                <a href="editProductServlet?pid=${o.getIdP()}">   <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
                                                                                                          data-toggle="modal" data-target="#ModalUP"><i class="fas fa-edit"></i>
                                                    </button></a> 
                                                <a href="deleteProduct?pid=${o.getIdP()}">  <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
